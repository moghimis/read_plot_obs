...
fig,ax = make_map()                                             
ax.scatter(x=purp_infos['Lon'][:],y=purp_infos['Lat'][:],s=10,c='purple',lw=0,label = 'Purple' ,alpha=0.7)                                                                                           
ax.scatter(x=epa_pm10_lons       ,y=epa_pm10_lats       ,s=10,c='blue'  ,lw=0,label = 'EPA PM10',alpha=0.7)
ax.scatter(x=epa_pm25_lons       ,y=epa_pm25_lats       ,s=10,c='red'   ,lw=0,label = 'EPA PM25',alpha=0.7)
ax.legend()  
